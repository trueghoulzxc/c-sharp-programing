...
internal class MyDate : IComparable<MyDate>
{
    private int _day;
    public int Day
    {
    ...
    public int CompareTo(MyDate? other)
    {
        ...
        res = this.Month.CompareTo(other.Month);
        if (res != 0) return res;

        res = this.Day.CompareTo(other.Day);
        return res;
    }

    public override string ToString() => $"{Day} {_monthNames[Month]} {Year} года";
